...
<div class="danger-zone"><h2>ลบบัญชี</h2><p>ลบบัญชีและข้อมูลที่เกี่ยวข้องอย่างถาวร ไม่สามารถกู้คืนได้</p><form method="post" action="account_delete.php" onsubmit="return confirm('ยืนยันลบบัญชี? ข้อมูลบัญชี งาน และความคิดเห็นจะถูกลบถาวรและกู้คืนไม่ได้')"><input type="hidden" name="csrf" value="<?= e(csrf_token()) ?>"><button class="danger-button" type="submit">ลบบัญชีถาวร</button></form></div>
